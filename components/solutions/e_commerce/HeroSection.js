  ...
  return (
    <section className="bg-black text-white py-20">
      <div className="max-w-6xl mx-auto px-4 text-left">
        ...
        <p className="text-lg md:text-xl text-gray-300 mb-6 max-w-2xl font-subheadline">
        ...
        <Link
          href="/book"
          className="bg-primaryCTA text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:opacity-90 inline-block font-subheadline"
        >
          Book Your Demo
        </Link>
      </div>
