          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-base text-gray-100">
              <p className="leading-relaxed drop-shadow-md font-paragraph">
                ...
                <span className="text-white font-medium"> Pick a time that works for you — it's instant and easy.</span>
              </p>
              
              <p className="text-lg font-semibold text-[#d4ff00] drop-shadow-md font-subheadline">
                This isn't just a demo - it's your first step to transformation.
              </p>
              
              <p className="leading-relaxed drop-shadow-md font-paragraph">
                We'll show you exactly how SparkAI can solve your specific challenges and 
                <span className="text-white font-medium"> deliver measurable results for your business.</span> 
                No pressure, just valuable insights tailored to your needs.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 relative shadow-2xl">
            <div className="text-center">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-100">
                  <div className="w-2 h-2 bg-[#d4ff00] rounded-full shadow-lg"></div>
                  <span className="font-paragraph">Instant booking - no waiting</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-gray-100">
                  <div className="w-2 h-2 bg-[#d4ff00] rounded-full shadow-lg"></div>
                  <span className="font-paragraph">Custom solution recommendations</span>
                </div>
              </div>
