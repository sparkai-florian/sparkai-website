          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-base text-gray-100">
              <p className="leading-relaxed drop-shadow-md font-paragraph">
                At SparkAI, we're not just building chatbots; we're building connections. 
                <span className="text-white font-medium"> Join us in transforming communication and helping businesses thrive in a fast-paced, digital world.</span>
              </p>
              
              <p className="text-lg font-semibold text-[#d4ff00] drop-shadow-md font-subheadline">
                This is more than technology - it's about human connection.
              </p>
              
              <p className="leading-relaxed drop-shadow-md font-paragraph">
                We believe that every message matters and every conversation counts. 
                <span className="text-white font-medium"> Let's work together to create intelligent solutions that enhance your business relationships and drive meaningful growth.</span>
              </p>
            </div>
          </div>
