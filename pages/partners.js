// ================================
// File: components/PartnersSection.js
// Description: Drop-in section placed between your <Header/> (nav) and <Footer/>
...
// - Replace /public/partners/*.svg with your actual assets
// ================================
...
const PARTNERS = [
  ...
  { name: "Instagram", src: "/partners/instagram.png", href: "#" },
  { name: "Facebook", src: "/partners/facebook.png", href: "#" },
  { name: "WhatsApp", src: "/partners/whatsapp.png", href: "#" },
  { name: "Telegram", src: "/partners/telegram.png", href: "#" },
  { name: "Viber", src: "/partners/viber.png", href: "#" },
...
const GROUPS = {
  All: PARTNERS,
  Platforms: [
    { name: "Chatbotbuilder", src: "/partners/chatbotbuilder.svg", href: "#" },
    { name: "OpenAI", src: "/partners/openai.svg", href: "#" },
    { name: "Gemini", src: "/partners/google-gemini.svg", href: "#" },
    { name: "FASHN AI", src: "/partners/fashnai.svg", href: "#" },
  ],
  Automation: [
    { name: "Make.com", src: "/partners/make.svg", href: "#" },
    { name: "Pabbly", src: "/partners/pabbly.svg", href: "#" },
  ],
  "Google Workspace": [
    { name: "Google Sheets", src: "/partners/google-sheets.svg", href: "#" },
    { name: "Google Calendar", src: "/partners/google-calendar.svg", href: "#" },
  ],
  Messaging: [
    { name: "Instagram", src: "/partners/instagram.svg", href: "#" },
    { name: "Facebook", src: "/partners/facebook.svg", href: "#" },
    { name: "WhatsApp", src: "/partners/whatsapp.svg", href: "#" },
    { name: "Telegram", src: "/partners/telegram.svg", href: "#" },
    { name: "Viber", src: "/partners/viber.svg", href: "#" },
    { name: "SMS", src: "/partners/sms.svg", href: "#" },
  ],
  Payments: [
    { name: "Stripe", src: "/partners/stripe.svg", href: "#" },
  ],
  CRM: [
    { name: "HubSpot", src: "/partners/hubspot.svg", href: "#" },
    { name: "Zoho", src: "/partners/zoho.svg", href: "#" },
  ],
  Notifications: [
    { name: "Pushover", src: "/partners/pushover.svg", href: "#" },
  ],
};
...
// If you use App Router, create app/partners/page.js and render <PartnersSection/>
// ================================
